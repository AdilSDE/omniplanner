...
/*
 * MarekS:
 * Manually applied patch https://issues.apache.org/jira/browse/FOP-2815
*/

/* $Id: AbstractFOPTranscoder.java 1761019 2016-09-16 10:43:45Z ssteiner $ */
...
//            ((Logger) logger).setLevel(Level.INFO);  // MarekS: this was causeing an error, there might be another way to set the INFO level
        }
        return this.logger;
    }
